...
- 포함: 대화용 `0x82xx`와 게임 메뉴용 `0x83xx`에 배치한 149자 한글 폰트, 프리뷰 레코드 28개
  (`0002`~`0012`, 게임 화면 공통 문구 11개, `0058`~`0063`)
- 초반 메뉴·이벤트 11개와 게임 화면 공통 문구 11개는 원래 슬롯에 맞춘 압축형 프리뷰 문구이며,
  자연스러운 전체 문구는 후속 재배치 대상
