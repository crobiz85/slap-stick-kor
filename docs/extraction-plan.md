...
- 대화 출력 루틴이 사용하는 `0x82xx` 페이지와 게임 메뉴용 `0x83xx` 페이지의 일본어 미사용
  슬롯을 한글 글리프 영역으로 잡아 초안과 게임 화면 문구에 필요한 247자를
...
- 공개 기술 메모에서 확인한 `02 1D [주소]` 대사 인덱스와 동일 은행 FF 여유 공간을 이용해
  대사 0058~0063을 재배치하고, 메뉴 0002~0012·0016~0020과 게임 화면 공통 문구 11개는
...
4. 한국어 글리프 위치와 텍스트 길이 제약을 자동 검증합니다. 메인 대사 0058~0063과
   슬롯에 들어가는 메뉴 0002~0012·0016~0020은 프리뷰 패치에 반영했습니다.
5. 남은 0001·0013~0015·0021~0035의 진입점과 은행 매핑을 확인해 재배치하고, 65816 포인터를
   갱신한 뒤 프리뷰 패치에 통합합니다.
...
중 슬롯에 들어가는 0002~0012·0016~0020과 게임 화면 공통 문구 11개는 원래 슬롯에
적용했고,
