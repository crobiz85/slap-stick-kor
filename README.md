...
- `scripts/build_korean_preview_patch.py`: 한글 폰트와 메뉴·게임 화면 문구·메인 대사 53개를
...
패치는 `0x80xx`·`0x81xx`의 미사용 코드에 넣은 207자 한글 폰트와
프리뷰 레코드 53개를 포함합니다. 메인 대사 0058~0063은 자연스러운 원고를 재배치하고,
